package com.uranus.dbflute.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("mst_element", "com.uranus.dbflute.bsentity.dbmeta.MstElementDbm");
        tmpMap.put("mst_relation", "com.uranus.dbflute.bsentity.dbmeta.MstRelationDbm");
